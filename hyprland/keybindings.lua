...
hl.bind(mainMod .. " + TAB", hl.dsp.exec_cmd("loginctl lock-session"))
...
hl.bind("ALT + G", hl.dsp.exec_cmd("~/.local/bin/launch-grandorgue"))
...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd("systemctl restart NetworkManager"))
